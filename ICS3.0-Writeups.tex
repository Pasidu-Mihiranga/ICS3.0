...
\newcommand{\repo}{https://github.com/Pasidu-Mihiranga/ICS3.0/blob/main/scripts}
...
repo. Every script lives in the \code{scripts/} folder at the repo root.
...
\solver{\repo/chameleo_great_power_solve.py}{chameleo_great_power_solve.py}
...
\solver{\repo/kotoamatsukami_exploit.py}{kotoamatsukami_exploit.py}
...
\solver{\repo/vanishing_stars_exploit.ps1}{vanishing_stars_exploit.ps1}
...
\solver{\repo/man_behind_the_mask_exploit.py}{man_behind_the_mask_exploit.py}
...
\solver{\repo/art_of_programming_solve.py}{art_of_programming_solve.py}
...
\solver{\repo/contaminated_container_decrypt.py}{contaminated_container_decrypt.py}
...
\solver{\repo/seventh_encore_decrypt.js}{seventh_encore_decrypt.js}
...
\vfill
\noindent{\small\itshape All solver scripts referenced above live in the
\code{scripts/} folder at the repo root, one file per challenge. The two
challenges without a script (The Leader, The Document That Remembers) were
worked through by hand / by re-running the challenge's own code, as described.
--- P.M.}
